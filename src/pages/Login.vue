...
<template>
  <div class="h-screen w-screen bg-no-repeat bg-cover lg:min-w-[1470px] lg:relative" style="background-image: url(../../src/assets/img/login.svg)">
    <div class="h-full w-full lg:backdrop-blur-md lg:flex lg:items-center lg:justify-center">
      <div class="h-full w-full lg:h-[915px] lg:w-[1470px] lg:min-w-[1470px] lg:shadow-md lg:relative">
        <!-- background -->
        <div
          class="w-full h-full bg-no-repeat bg-cover lg:w-1/2 lg:bg-auto lg:absolute lg:left-0 lg:transition-all lg:duration-300 lg:ease-in-out"
        ...
        <!-- login_box -->
        <div
          class="lg:w-1/2 lg:h-full lg:flex lg:items-center justify-center lg:bg-white lg:opacity-80 lg:flex-shrink-0 lg:absolute lg:right-0 lg:transition-all lg:duration-300 lg:ease-in-out"
          :class="{'lg:mr-0': loginOrSign, 'lg:mr-[735px]': !loginOrSign, 'lg:rounded-r-md': loginOrSign, 'lg:rounded-l-md': !loginOrSign}"
        >
          <div
            class="px-8 w-[400px] h-[600px] fixed inset-0 m-auto rounded-lg backdrop-blur-md backdrop-brightness-90 backdrop-contrast-75 backdrop-opacity-90 lg:m-0 lg:static lg:backdrop-blur-none lg:backdrop-brightness-0 lg:backdrop-contrast-0 lg:backdrop-opacity-0 lg:shadow-md"
          >
            <!-- internal login box -->
            <div class="w-full h-full">
              ...
              >
                <el-form-item>
                  ...
                  >
                    <h1 class="antialiased text-4xl font-bold" v-if="loginOrSign">登陆</h1>
                    <h1 class="antialiased text-4xl font-bold" v-else>注册</h1>
                  </transition>
                </el-form-item>
                <el-form-item>
                  <!-- Options -->
                ...
                >
                  <div v-if="loginOrSign" class="h-2/3 flex flex-col justify-between">
                    ...
                    <el-form-item size="large" key="loginBtn">
                      <el-button @click="loginSubmitForm(loginFormRef)" type="primary">登陆</el-button>
                    </el-form-item>
